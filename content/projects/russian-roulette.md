---
title: "A Kinder Russian Roulette — Encryption Practice"
date: 2026-03-12
tags: ["windows", "maldev", "encryption", "CTF", "reverse-engineering"]
summary: "Six chambers, six encryption/obfuscation methods. A CTF-style tool for practicing Ghidra analysis and decryption routine writing — from XOR to AES-256 CBC to UUID obfuscation."
---
...
![Tool output — chamber selected, file encrypted](/images/projects/roulette-console.png)
...
![Encrypted outputs — binary blobs, IPv4 lists, UUIDs](/images/projects/roulette-outputs.png)
...
You have `encrypted_2.bin` and the tool's `.exe`. Nothing else. Here's the full path from zero to plaintext.
...
You get a hit: `"Choose the file Major : "`. That's where the main function should be. Ghidra doesn't know it's called `main` — it stripped all symbols at compile time. The XREF tells you which function uses that string, and since you wrote that string in `main`, that function *is* main.

Double click the XREF — you land in `FUN_1400013c0`.

![Ghidra Defined Strings — locating main via XREF](/images/projects/roulette-ghidra-strings.png)
...
![Ghidra decompiler — RC4 case with SystemFunction032](/images/projects/roulette-ghidra-rc4.png)
...
![Ghidra full view — decompiler and listing side by side](/images/projects/roulette-ghidra-decompiler.png)
...
![Decrypted output — Hello Major!](/images/projects/roulette-decrypted.png)
